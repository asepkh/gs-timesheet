...
const { Option } = Select;
const Timesheet = () => {
  const { date, setDate, modal, setModal, dateFormat, timesheet, companyList, workLocationList, onFinish, onRemove } =
    useController();
    ...
    <Card>
      <Row justify="space-between" style={{ marginBottom: 20 }}>
        ...
        <div style={{ display: "flex" }}>
          ...
          <Select disabled={!date?.custom} value={date?.year} onChange={(value) => setDate({ ...date, year: value })}>
